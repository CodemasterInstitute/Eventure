        ...
        <h1>Sign Up:</h1>
            <form class="needs-validation" id="signup-form" novalidate>
                <div class="form-row">
                    ...
                    <input type="firstname" class="form-control" id="newFName" placeholder="First Name" required>
                    ...
                    <input type="lastname" class="form-control" id="newLName" placeholder="Last Name" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" class="form-control" id="newEmailAddress" placeholder="name@email.com" required>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="username" class="form-control" id="newUsername" placeholder="eventurer1234567" required>
                    <div class="invalid-feedback">
